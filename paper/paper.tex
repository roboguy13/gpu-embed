...
% Say what problem is
  ...
  deeply embedded domain specific languages.
  Rather than use
  the builtin control flow mechanisms, artifical control flow combinators
  are used instead.
...
% Say why it is an interesting problem
  ...
  would allow for writing programs in a natural style, and enables the programmer to use the
