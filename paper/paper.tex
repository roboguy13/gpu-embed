...
constructs which have often proved illusive to embed in an EDSL. One prominent
example is that of a \ttt{case} expression. Pattern matching is a convenient way
to implement control flow structures and to view components of data structures,
so it is frequently a desirable feature for many EDSLs.
