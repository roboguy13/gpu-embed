...
% Say what problem is
  ...
  deeply embedded domain specific languages. Clunky, awkward workarounds must be
  employed which will be less familiar than the builtin control flow mechanisms
...
% Here is why the world will be a better place
  ...
  deeply embedded domain specific languages can be cleaner, more Haskell idiomatic,
