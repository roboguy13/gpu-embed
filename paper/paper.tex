...
\begin{align*}
  ...
  T'_{\ttt{f}}&\expr{\ttt{\{ K x0 ... xN $\rarr$ body0; ... \}}}\\
    &\rewrites
      \begin{cases}
        \ttt{\{ K x0 ... xN $\rarr$ body0}[\ttt{f} \mapsto \ttt{Step}]\ttt{; }T'_{\ttt{f}}\expr{\ttt{\{ ... \}}}\ttt{ \}} & \text{if \ttt{f} occurs free in \ttt{body0}}\\
        \ttt{\{ K x0 ... xN $\rarr$ Done body0; $T'_{\ttt{f}}\expr{\ttt{\{ ... \}}} \}$} & \text{otherwise}
      \end{cases}\\
