...
\title[On Adding Pattern Matching to Haskell-based EDSLs]{On Adding Pattern Matching to Haskell-based
...
In this paper, a C backend is given as an example. The Core plugin will
...
A C backend is described in this paper. However, other backends could be constructed,
...
\begin{figure*}
  \centering 
  \resizebox{2.0\columnwidth}{20cm}{\includegraphics{Diagrams/Flowchart.pdf}}
