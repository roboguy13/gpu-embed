...
In the example below, \texttt{example} would get transformed into \texttt{example'}:
...
[Remove metadata from Generic representation and turn tree-like structure into a list-like structure]

\subsection{E, Rep, RepTy}
