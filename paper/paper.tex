...
In the following flowchart, the names in parentheses in a node refers to the names of transformations from the following section (Section 8.2).
...
\node (start) [startstop] {Core from GHC};
  ...
  \draw [arrow] (findmark) -- node[anchor=west, yshift=0.1cm] {Function application/non-prim var} (handleapp);
